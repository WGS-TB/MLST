...
def main():
    ...
    ap.add_argument("-d", "--masterDir", required=False, default=os.getcwd(), help="The absolute path to the master directory to run the simulation and store the results")
