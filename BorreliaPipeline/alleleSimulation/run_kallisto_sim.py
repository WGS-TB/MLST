...
def main_simulationFunc(locus, iteration, originalPath, simulationResultFolder, cov, ed, art, kal):
    ...
    precision, recall, totalVarDist_count = sim.simulation(locus,iteration,originalPath, simulationResultFolder, cov, ed , art, kal)
    ...
    return precision, recall, totalVarDist_count
...
for locus in genes:
    ...
    if args["fullPaper"] == False:
        precision, recall, totalVarDist_count = main_simulationFunc(locus,args["numOfIter"],originalPath, args["simulationResultFolder"], args["coverage"], args["editDist"],art, kal)
        precision_list.append(precision)
        recall_list.append(recall)
        totalVarDist_count_list.append(totalVarDist_count)
    else:
...
#                print ed
                precision, recall, totalVarDist_count = main_simulationFunc(locus,args["numOfIter"],originalPath, args["simulationResultFolder"], cov, ed, art, kal)
