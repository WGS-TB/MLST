...
def generateNewRefNewStr(refStrains, loci, writePath, df_justStrains_new):
    ...
    for i in range(1,11):
        ...
        temp.to_csv("{0}/strain_ref{1}.txt".format(writePath, i),sep='\t')
...
def generateNewRefRemoveExist(refStrains, remove, loci, ind, writePath):
    ...
    new_ref.to_csv("{0}/e_strain_ref{1}.txt".format(writePath, ind), sep='\t')
...
strainsAndPropFolder = "/home/glgan/Documents/Borrelia/pipeline/strainsAndProp_3hr"
